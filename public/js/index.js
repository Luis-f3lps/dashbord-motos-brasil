...
// Mapeamento fixo de cores por Fabricante conforme solicitado
const coresFabricantes = {
  ...
  'BMW': '#ffffff',            // Branco (com borda visível)
  'TRIUMPH': '#006400',        // Verde-escuro
  'KTM': '#ff8c00',            // Laranja
  'ROYAL ENFIELD': '#8b4513',  // Marrom
  'SHINERAY': '#ff69b4',       // Rosa
  'MOTTU': '#008000',          // Verde
  'AVELLOZ': '#ffd700',        // Amarelo
  'BAJAJ': '#c0c0c0',          // Prata
  'HAOJUE': '#800080',         // Roxo
  'OUTROS': '#808080'          // Cinza
};

// Função auxiliar para retornar a cor correta da marca
...
function renderizarSecaoTipoMes(dados) {
  ...
  // Cores baseadas nas marcas para o gráfico de tipo/modelo
